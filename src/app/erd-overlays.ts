 ...
 * @param lineLength
 */
function drawOneBar(connector:ConnectorPath, loc:number, offset:number, lineWidth:number, lineLength:number, stroke:string|undefined) {
...
function drawOneCircle(connector:ConnectorPath, loc:number, offset:number, lineWidth:number, r:number, stroke:string|undefined, fill:string) {
...
function drawOneFoot(connector:ConnectorPath, loc:number, offset:number, width:number, length:number, lineWidth:number, stroke:string|undefined) {
    const mult = loc < 0.5 ? 1 : -1
